...
public class Player2Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.LeftArrow)) moveX = -1; // Izquierda
        if (Input.GetKey(KeyCode.RightArrow)) moveX = 1; // Derecha
        ...
        if (Input.GetKeyDown(KeyCode.P))
        {
            ...
            {
                hit.collider.GetComponent<Player1Controller>().TakeDamage(damage);
            }
        }
    }
